                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="emai;"  class="form-control" value="{{ ($profileData->email) }}">
                                        </div>
                                    </div>
...
<div class="col-lg-12 col-md-6">
    <div class="form-group">
        ...
        $profileData->photo) : url('upload/no_image.jpg') }}" alt="Admin" class="rounded-circle 
        p-1 bg-primary" width="80">
    </div>
</div>
