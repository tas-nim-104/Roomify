   ...
   <!-- Inner Banner -->
        ...
        @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" required data-error="Please enter password confirmation" placeholder="Confirm Password">
                                            </div>
                                        </div>
